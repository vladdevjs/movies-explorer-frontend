        ...
        <form className='register__form' onSubmit={handleSubmit}>
          <fieldset className='register__fieldset'>
            ...
            <input
              ...
              minLength='2'
              required
              className={`register__field ${errors.name && 'register__field_error'}`}
              value={values.name || ''}
            ...
            <input
              ...
              minLength='8'
              required
              className={`register__field ${errors.password && 'register__field_error'}`}
              onChange={handleChangeInput}
            />
            <span className='register__error-message'>{errors.password}</span>
          </fieldset>
          <div className='register__wrapper'>
            <span className='register__error-message register__error-message_main'>{errorMessage}</span>
            <button
              type='submit'
              className={`button register__button ${!isValid || errorMessage ? 'register__button_disabled' : ''}`}
